 ...
 */
class getFinderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FinderRepository' shared autowired service.
     *
     * @return \App\Repository\FinderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FinderRepository.php';

        return $container->privates['App\\Repository\\FinderRepository'] = new \App\Repository\FinderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
