...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerOfiuFTQ\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerOfiuFTQ/PaginatorProxyBa079e5.php';
require __DIR__.'/ContainerOfiuFTQ/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerOfiuFTQ/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerOfiuFTQ/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerOfiuFTQ/getValidator_WhenService.php';
require __DIR__.'/ContainerOfiuFTQ/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerOfiuFTQ/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerOfiuFTQ/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerOfiuFTQ/getValidator_ExpressionService.php';
require __DIR__.'/ContainerOfiuFTQ/getValidator_EmailService.php';
require __DIR__.'/ContainerOfiuFTQ/getUx_TwigComponent_Twig_ComponentRuntimeService.php';
require __DIR__.'/ContainerOfiuFTQ/getUx_TwigComponent_ComponentRendererService.php';
require __DIR__.'/ContainerOfiuFTQ/getUx_TwigComponent_ComponentPropertiesService.php';
require __DIR__.'/ContainerOfiuFTQ/getUx_TwigComponent_ComponentFactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getUriSignerService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_ValidatorService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_Runtime_ImportmapService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_Form_EngineService.php';
require __DIR__.'/ContainerOfiuFTQ/getTwig_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerOfiuFTQ/getTurbo_Twig_RuntimeService.php';
require __DIR__.'/ContainerOfiuFTQ/getTurbo_Doctrine_EventListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerOfiuFTQ/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerOfiuFTQ/getTexter_TransportsService.php';
require __DIR__.'/ContainerOfiuFTQ/getTailwind_CssAssetCompilerService.php';
require __DIR__.'/ContainerOfiuFTQ/getTailwind_BuilderService.php';
require __DIR__.'/ContainerOfiuFTQ/getStimulus_UxControllersTwigRuntimeService.php';
require __DIR__.'/ContainerOfiuFTQ/getStimulus_AssetMapper_LoaderJavascriptCompilerService.php';
require __DIR__.'/ContainerOfiuFTQ/getStimulus_AssetMapper_ControllersMapGeneratorService.php';
require __DIR__.'/ContainerOfiuFTQ/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerOfiuFTQ/getSession_FactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getServicesResetterService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_User_Provider_Concrete_UsersInDatabaseService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_Authenticator_FormLogin_MainService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecrets_VaultService.php';
require __DIR__.'/ContainerOfiuFTQ/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerOfiuFTQ/getRouting_LoaderService.php';
require __DIR__.'/ContainerOfiuFTQ/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerOfiuFTQ/getPropertyInfo_ConstructorExtractorService.php';
require __DIR__.'/ContainerOfiuFTQ/getNotifier_TransportFactory_NullService.php';
require __DIR__.'/ContainerOfiuFTQ/getMonolog_Logger_MessengerService.php';
require __DIR__.'/ContainerOfiuFTQ/getMonolog_Logger_MailerService.php';
require __DIR__.'/ContainerOfiuFTQ/getMonolog_Logger_DeprecationService.php';
require __DIR__.'/ContainerOfiuFTQ/getMonolog_Logger_AssetMapperService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_TransportFactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Transport_Sync_FactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Transport_InMemory_FactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Transport_FailedService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Transport_Doctrine_FactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Transport_AsyncService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_RoutableMessageBusService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Retry_SendFailedMessageForRetryListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Retry_MultiplierRetryStrategy_FailedService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Retry_MultiplierRetryStrategy_AsyncService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Listener_StopWorkerOnRestartSignalListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Failure_SendFailedMessageToFailureTransportListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Bus_Default_Middleware_TraceableService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Bus_Default_Middleware_SendMessageService.php';
require __DIR__.'/ContainerOfiuFTQ/getMessenger_Bus_Default_Middleware_HandleMessageService.php';
require __DIR__.'/ContainerOfiuFTQ/getMailer_TransportsService.php';
require __DIR__.'/ContainerOfiuFTQ/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/ContainerOfiuFTQ/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/ContainerOfiuFTQ/getMailer_TransportFactory_NullService.php';
require __DIR__.'/ContainerOfiuFTQ/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/ContainerOfiuFTQ/getKnpPaginatorService.php';
require __DIR__.'/ContainerOfiuFTQ/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_Password_PasswordHasherService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_Form_PasswordHasherService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_Type_FormService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_Type_FileService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_Type_EntityService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_Type_ColorService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_ServerParamsService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_RegistryService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_Listener_PasswordHasherService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_FactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerOfiuFTQ/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerOfiuFTQ/getErrorControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_Messenger_EventSubscriber_DoctrineClearEntityManagerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_Messenger_DoctrineSchemaListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerOfiuFTQ/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerOfiuFTQ/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerOfiuFTQ/getDebug_Security_Authenticator_FormLogin_MainService.php';
require __DIR__.'/ContainerOfiuFTQ/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerOfiuFTQ/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerOfiuFTQ/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerOfiuFTQ/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerOfiuFTQ/getContainer_GetenvService.php';
require __DIR__.'/ContainerOfiuFTQ/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerOfiuFTQ/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerOfiuFTQ/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerOfiuFTQ/getCache_SystemClearerService.php';
require __DIR__.'/ContainerOfiuFTQ/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerOfiuFTQ/getCache_AppClearerService.php';
require __DIR__.'/ContainerOfiuFTQ/getAssetMapper_Importmap_GeneratorService.php';
require __DIR__.'/ContainerOfiuFTQ/getAssetMapper_Importmap_ConfigReaderService.php';
require __DIR__.'/ContainerOfiuFTQ/getAssetMapper_Compiler_JavascriptImportPathCompilerService.php';
require __DIR__.'/ContainerOfiuFTQ/getAssetMapper_Compiler_CssAssetUrlCompilerService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Validator_State_ErrorProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Symfony_MainControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_SwaggerUi_ProcessorService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_StateProvider_ParameterValidatorService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_StateProvider_Parameter_IriConverterService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_StateProvider_ObjectService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_StateProvider_CreateService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_StateProvider_ContentNegotiationService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_StateProvider_BackedEnumService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_StateProcessor_WriteService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_State_ErrorProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Serializer_FilterParameterProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Openapi_SerializerContextBuilderService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Openapi_ProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_JsonSchema_BackwardCompatibleSchemaFactoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_State_RemoveProcessorService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_State_PersistProcessorService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_State_ItemProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_State_CollectionProviderService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_LinksHandlerService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Doctrine_Orm_Extension_ParameterExtensionService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerOfiuFTQ/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerOfiuFTQ/getTemplateControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getRedirectControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getRequestArgumentAccessService.php';
require __DIR__.'/ContainerOfiuFTQ/getPaginationRuntimeService.php';
require __DIR__.'/ContainerOfiuFTQ/getProfilerControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getNavbarService.php';
require __DIR__.'/ContainerOfiuFTQ/getUserRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getTypeRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getRoleRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getPokemonTranslationRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getPokemonSpriteRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getPokemonRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getFinderRepositoryService.php';
require __DIR__.'/ContainerOfiuFTQ/getRegistrationFormTypeService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonTypeService.php';
require __DIR__.'/ContainerOfiuFTQ/getUserControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getShopControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getPokemonsControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/getProcessorService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_ZHyJIs5_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_ZHyJIs5_KernelloadRoutesService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_ZHyJIs5Service.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_YwxAJhqService.php';
require __DIR__.'/ContainerOfiuFTQ/getPokemonsControllerindexService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_JsQaLu1Service.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_AVKDDNUService.php';
require __DIR__.'/ContainerOfiuFTQ/getPokemonsControllershowService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_ZyP9f7KService.php';
require __DIR__.'/ContainerOfiuFTQ/getShopControllersuccessService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonControllereditService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonControllerdeleteService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_QcfG1fnService.php';
require __DIR__.'/ContainerOfiuFTQ/getShopControllerwebhookStripeService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonControllernewService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_Kq27LHMService.php';
require __DIR__.'/ContainerOfiuFTQ/getShopControllerindexService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonControllerindexService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_73Qjsm7Service.php';
require __DIR__.'/ContainerOfiuFTQ/getUserControllerregisterService.php';
require __DIR__.'/ContainerOfiuFTQ/getUserControllerloginService.php';
require __DIR__.'/ContainerOfiuFTQ/getShopControllershowService.php';
require __DIR__.'/ContainerOfiuFTQ/getShopControllercheckoutService.php';
require __DIR__.'/ContainerOfiuFTQ/getLocamonControllershowService.php';
require __DIR__.'/ContainerOfiuFTQ/get_ServiceLocator_1czhfrBService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_JyyWvHwService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_GEx8y9aService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_WG_ORBvService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_UKIJHilService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_Qv3faSNService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_NumTeF8Service.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_EXsqOW5Service.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_Dkv9sRYService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Messenger_HandlerDescriptor_Die6BxeService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_UidService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_ValueResolver_ApiPlatform_ArgumentResolver_PayloadService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_Security_Voter_Security_Access_ClosureVoterService.php';
require __DIR__.'/ContainerOfiuFTQ/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Controller\LocamonController';
$classes[] = 'App\Controller\PokemonsController';
$classes[] = 'App\Controller\ShopController';
$classes[] = 'App\Controller\UserController';
$classes[] = 'App\Form\LocamonType';
$classes[] = 'App\Form\RegistrationFormType';
$classes[] = 'App\Repository\FinderRepository';
$classes[] = 'App\Repository\LocamonRepository';
$classes[] = 'App\Repository\PokemonRepository';
$classes[] = 'App\Repository\PokemonSpriteRepository';
$classes[] = 'App\Repository\PokemonTranslationRepository';
