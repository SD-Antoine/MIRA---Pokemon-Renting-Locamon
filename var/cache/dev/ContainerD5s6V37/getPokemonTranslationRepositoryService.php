 ...
 */
class getPokemonTranslationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PokemonTranslationRepository' shared autowired service.
     *
     * @return \App\Repository\PokemonTranslationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PokemonTranslationRepository.php';

        return $container->privates['App\\Repository\\PokemonTranslationRepository'] = new \App\Repository\PokemonTranslationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
