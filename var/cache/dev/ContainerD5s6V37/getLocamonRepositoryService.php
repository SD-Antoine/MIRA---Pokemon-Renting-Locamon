 ...
 */
class getLocamonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LocamonRepository' shared autowired service.
     *
     * @return \App\Repository\LocamonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LocamonRepository.php';

        return $container->privates['App\\Repository\\LocamonRepository'] = new \App\Repository\LocamonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
