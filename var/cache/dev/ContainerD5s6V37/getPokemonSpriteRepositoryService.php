 ...
 */
class getPokemonSpriteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PokemonSpriteRepository' shared autowired service.
     *
     * @return \App\Repository\PokemonSpriteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PokemonSpriteRepository.php';

        return $container->privates['App\\Repository\\PokemonSpriteRepository'] = new \App\Repository\PokemonSpriteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
