 ...
 */
final class Version20251118093055 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD type1_id INT NOT NULL, ADD type2_id INT DEFAULT NULL, DROP type1, DROP type2');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pokemon ADD type2 INT NOT NULL, DROP type2_id, CHANGE type1_id type1 INT NOT NULL');
    }
}
